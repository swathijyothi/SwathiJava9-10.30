...
parameters.put("MOBILE_NO","8281452150");
parameters.put("EMAIL","swathisadanam@gmail.com");
parameters.put("CALLBACK_URL", "http://localhost:8081/FammsProject/pgResponse.jsp");
