                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                          ...
                          <b> <li style="color:red">Category:</li></b>
                              <li><a href="product_filter.jsp?product_category=mens">-Mens</a></li>
                              <li><a href="product_filter.jsp?product_category=womens">-Womens</a></li>
                              <li><a href="product_filter.jsp?product_category=kids">-kids</a></li>
