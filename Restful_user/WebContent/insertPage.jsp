...
<div class="signup-form">
    <form action="MainServlet"  method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-6"><input type="text" class="form-control" name="firstname" placeholder="First Name" onblur="checkFname()" required="required">
				<span id="fname"></span>
				</div>
        ...
        <div >Gender:
            <input type="radio" class="form-control" name="gender" value="male" required="required">male
            <input type="radio" class="form-control" name="gender" value="female" required="required">female
        </div>
		<div class="form-group">
       ...
       <div>
		...
		<div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg" name="action" value="insert">Insert</button>
        </div>
    </form>
